...
(1, 'WHERE 조건 필터링', 'easy', 'WHERE',
 'salary가 700만원 이상인 직원의 emp_name, job_title, salary를 조회하세요.',
...
-- CH2: DISTINCT & 집계 함수
INSERT INTO problems (chapter_id, title, difficulty, concept, description, hint, answer_sql, concept_explain, sort_order) VALUES
(2, 'DISTINCT - 중복 제거', 'easy', 'DISTINCT',
...
(2, 'SUM / AVG / MAX / MIN', 'easy', 'SUM, AVG, MAX, MIN',
...
(2, 'GROUP BY - 그룹 집계', 'medium', 'GROUP BY',
...
(2, 'HAVING - 그룹 조건 필터', 'medium', 'HAVING',
...
-- CH3: JOIN
INSERT INTO problems (chapter_id, title, difficulty, concept, description, hint, answer_sql, concept_explain, sort_order) VALUES
(3, 'INNER JOIN - 기본', 'medium', 'INNER JOIN',
...
(3, 'LEFT JOIN - 포함 조회', 'medium', 'LEFT JOIN',
...
(3, '3개 테이블 JOIN', 'medium', 'Multi-table JOIN',
...
-- CH4: 서브쿼리
INSERT INTO problems (chapter_id, title, difficulty, concept, description, hint, answer_sql, concept_explain, sort_order) VALUES
(4, '스칼라 서브쿼리', 'medium', 'Scalar Subquery',
...
(4, 'WHERE 서브쿼리', 'medium', 'Subquery in WHERE',
...
(5, 'WITH 다중 CTE', 'hard', 'Multiple CTE',
...
-- CH6: CASE WHEN
INSERT INTO problems (chapter_id, title, difficulty, concept, description, hint, answer_sql, concept_explain, sort_order) VALUES
(6, 'CASE WHEN 기본', 'medium', 'CASE WHEN',
...
(6, 'CASE WHEN + GROUP BY', 'hard', 'CASE WHEN + 집계',
...
(7, 'RANK vs DENSE_RANK', 'hard', 'RANK, DENSE_RANK',
...
(7, 'SUM OVER - 누적 합계', 'hard', 'SUM() OVER',
...
-- CH8: 문자열 & 날짜 함수
INSERT INTO problems (chapter_id, title, difficulty, concept, description, hint, answer_sql, concept_explain, sort_order) VALUES
(8, 'SUBSTR - 문자열 자르기', 'medium', 'SUBSTR',
...
(8, 'DATE 함수 - 날짜 계산', 'medium', 'DATEDIFF, DATE_FORMAT',
...
(8, 'GROUP_CONCAT - 목록 합치기', 'hard', 'GROUP_CONCAT',
...
-- CH9: 종합 실전 문제
INSERT INTO problems (chapter_id, title, difficulty, concept, description, hint, answer_sql, concept_explain, sort_order) VALUES
(9, '부서별 주문 통계', 'hard', '종합 JOIN + GROUP BY',
...
(9, '가장 많이 팔린 상품 TOP 3', 'hard', 'JOIN + 집계 + LIMIT',
...
(9, '부서별 급여 1등 직원', 'hard', 'ROW_NUMBER + WITH + 필터',
